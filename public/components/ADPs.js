...
function cards(buildingBlocks, setFlyoutVisibility) {
    const cardNodes = Object.keys(buildingBlocks).map(function (key, index) {
        return (
            <EuiFlexItem style={{ width: 400 }} grow={false} key={index}>
                <EuiCard
...
function flyout(isFlyoutVisible, setFlyoutVisibility, handleInputChange, handleSubmit, id, name, description,
                events, entity, expressionType, expression, entitiesList, eventsList,
            ...
            maxWidth={750}>
                ...
                <EuiFlyoutBody>
                        ...
                        <EuiFormRow fullWidth label="Type">
                            <EuiFieldText fullWidth name="expressionType" value={expressionType} onChange={e => handleInputChange(e)}/>
                        </EuiFormRow>
